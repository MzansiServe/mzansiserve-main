...
const ServiceProviderDashboard = () => {
    ...
    const navItems = [
        ...
        { id: "active", label: "Active Bookings", icon: Clock },
        { id: "rides", label: "Available Requests", icon: ClipboardList },
            ...
            >
                <Box sx={{ display: 'flex', gap: 2 }}>
                    ...
                    <Box>
                        ...
                        <Typography variant="body2" sx={{ color: 'text.secondary', mb: 2 }}>Complete these steps to start receiving service bookings:</Typography>
                        <Stack spacing={1}>
    ...
    return (
        <DashboardLayout
            ...
            displayName={authUser?.name || "Service Provider"}
            role="Service Provider"
