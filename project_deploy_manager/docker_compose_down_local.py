#!/usr/bin/env python3
"""Run docker compose down in the project directory. Exit 0 on success."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run docker compose down locally.")
    ...
    code, out, err = run_local(" ".join(cmd_parts), timeout_sec=120)
    if code != 0:
