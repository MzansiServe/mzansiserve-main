#!/usr/bin/env python3
"""Run docker compose up -d --build locally. Exit 0 on success."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run docker compose up -d --build locally.")
